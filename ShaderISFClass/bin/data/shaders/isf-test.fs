...
//	gl_FragColor.ba = mix(gl_FragColor.ba, stalePixel.ba, (sin(TIME * 0.16) / 6.283) * 0.2 + 0.8);
    ...
    gl_FragColor.rg = mix(gl_FragColor.rg, stalePixel.rg, (sin(TIME * 0.001) / 6.283) * 0.2 + 0.9);
    gl_FragColor.rb = mix(gl_FragColor.rb, stalePixel.rb, (sin(TIME * 0.001) / 6.283) * 0.2 + 0.2);
	gl_FragColor.ba = mix(gl_FragColor.ba, stalePixel.ba, (sin(TIME * 0.001) / 6.283) * 0.2 + 0.9);
